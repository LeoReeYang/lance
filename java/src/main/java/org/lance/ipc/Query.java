...
public class Query {
  ...
  public static class Builder {
     ...
     *
     * <p>This API accepts a single query vector. The array length must match the target
     * vector column dimension. Batch nearest-neighbor search with multiple query vectors
     * requires a list-shaped query input and is not available through this {@code float[]}
     * entry point.
     *

...
criterion_group!(
    ...
    targets=bench_creation, bench_get_single, bench_apply_row_id, bench_shot_table, bench_mask_to_offset_ranges, bench_bitmap_mask_density, bench_broad_dataset_wide_mask);
